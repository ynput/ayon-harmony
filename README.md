...
- creators for:
  - render - locally/farm
  - palette - automatic during collection
  - template - group of nodes wrapped in Backdrop
- loaders for:
  - audio
  - background - json file and list of images
  - image sequences
  - palette
  - template
  - whole Harmony workfile

It should reasonably support even Harmony Advanced (without Node View) - templates will not work as
it is required to wrap nodes that should be in a template which is not possible without Node View.
